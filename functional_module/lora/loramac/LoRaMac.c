 ...
 */
RTC_DATA_ATTR static TimerEvent_t TxDelayedTimer;
 ...
 */
RTC_DATA_ATTR static TimerEvent_t RxWindowTimer1;
RTC_DATA_ATTR static TimerEvent_t RxWindowTimer2;
 ...
 */
RTC_DATA_ATTR static uint32_t RxWindow1Delay;
RTC_DATA_ATTR static uint32_t RxWindow2Delay;
 ...
 */
RTC_DATA_ATTR static TimerEvent_t AckTimeoutTimer;

/*!
 * Number of trials to get a frame acknowledged
 */
RTC_DATA_ATTR static uint8_t AckTimeoutRetries = 1;

/*!
 * Number of trials to get a frame acknowledged
 */
RTC_DATA_ATTR static uint8_t AckTimeoutRetriesCounter = 1;

/*!
 * Indicates if the AckTimeout timer has expired or not
 */
RTC_DATA_ATTR static bool AckTimeoutRetry = false;
 ...
 */
RTC_DATA_ATTR static uint8_t JoinRequestTrials;

/*!
 * Maximum number of trials for the Join Request
 */
RTC_DATA_ATTR static uint8_t MaxJoinRequestTrials;

/*!
 * Structure to hold an MCPS indication data.
 */
RTC_DATA_ATTR static McpsIndication_t McpsIndication;

/*!
 * Structure to hold MCPS confirm data.
 */
RTC_DATA_ATTR static McpsConfirm_t McpsConfirm;

/*!
 * Structure to hold MLME indication data.
 */
RTC_DATA_ATTR static MlmeIndication_t MlmeIndication;

/*!
 * Structure to hold MLME confirm data.
 */
RTC_DATA_ATTR static MlmeConfirm_t MlmeConfirm;

/*!
 * Holds the current rx window slot
 */
RTC_DATA_ATTR static LoRaMacRxSlot_t RxSlot;
